                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 mb-4">
                      <h4 className="font-medium text-gray-900 mb-2">{t('customerInformation')}</h4>
                          ...
                          <div key={item.id} className="flex items-center justify-between p-3 bg-white rounded-lg border">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-500">{t('item')}: {item.quantity}</p>
                              </div>
                            </div>
                            <div className="text-right">
                  ...
                  <div className="flex flex-col space-y-2 ml-4">
                    ...
                    {getNextStatus(order.status) && (
                      ...
                      >
                        {t('markAs')} {getNextStatus(order.status)}
                      </Button>
                    )}
                    <DropdownMenu>
        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center space-x-2 mt-8">
            ...
            <span className="text-sm text-gray-700">
              {tCommon('page') || 'Page'} {currentPage} {tCommon('of')} {totalPages}
            </span>
            <Button
              variant="outline"
              size="sm"
